...
function WhatsAppShareButton({ url, editionName }: { url: string; editionName: string }) {
  const shareText = `Entrar na edição ${editionName}:\n${url}`;
  ...
  return (
    <a
      ...
      className="inline-flex shrink-0 items-center gap-1.5 rounded-lg bg-[#25D366] px-3 py-1.5 text-xs font-semibold text-white transition-opacity hover:opacity-90"
    >
      <svg
        aria-hidden
        viewBox="0 0 24 24"
